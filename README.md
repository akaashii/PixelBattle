...
Pixel Battle для групповых чатов Telegram. Две команды захватывают холст 100×100, рисуя пиксель-арты палитрой из 32 цветов. Побеждает команда, захватившая больше пикселей за 24 часа.
